...
seznam_serija_knjiga = []  # nujno moraš narediti nov seznam, sicer se zaplete z indeksiranjem in for zanka ne deluje
...
orodja.zapisi_tabelo(dckb.seznam_vseh_knjig_kljucnih_besed, ['id_knjige', 'kljucna_beseda'],
                     'podatki/knjiga_kljucne_besede.csv')
