...
vzorec_zanri =re.compile("""<div class="dataItem">\s*<a href="/genres.*?">(?P<zanr1>.*?)</a>(, <a href="/genres.*?">(?P<zanr2>.*?)</a>)?(, <a href="/genres.*?">(?P<zanr3>.*?)</a>)?(, <a href="/genres.*?">(?P<zanr4>.*?)</a>)?(, <a href="/genres.*?">(?P<zanr5>.*?)</a>)?\s*?</div>""")
